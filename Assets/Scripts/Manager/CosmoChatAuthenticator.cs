...
[AddComponentMenu("")]
public class CosmoChatAuthenticator : NetworkAuthenticator
{
    ...
    public void OnAuthRequestMessage(NetworkConnectionToClient conn, AuthRequestMessage msg)
    {
        ...
        if (!PlayerData.playerNames.Contains(msg.authUsername + "2122123212321")) //TODO : Настроить на 1 пользователя. Будет вход по логину и паролю. Туда будем передавать логин
        {
            // Add the name to the HashSet
            PlayerData.playerNames.Add(msg.authUsername);
